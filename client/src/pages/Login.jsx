...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (state === "register" && showOtpInput) {
  ...
  return (
    ...
    >
      <p className="text-2xl font-medium m-auto">
        ...
        {showOtpInput ? "Verify OTP" : state === "login" ? "Login" : "Sign Up"}
      </p>
      ...
      {!showOtpInput ? (
        ...
        <div className="w-full">
          ...
          <p className="text-sm mt-2 text-gray-500">
            ...
            <span 
              onClick={resendOtp}
              className="text-purple-700 cursor-pointer ml-2"
            >
              Resend OTP
            </span>
          </p>
